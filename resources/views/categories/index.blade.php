    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function setupCarousel() {
            ...
            if (screenWidth < 768) { // Mobile
                slidesPerView = 1;
            } else if (screenWidth < 1280) { // Tablet
                slidesPerView = 2;
            } else { // Desktop
                slidesPerView = 3;
            }
            ...
            // Set the width of each slide dynamically to fit the view
            slides.forEach(slide => {
                // The 16px accounts for the `mx-2` margin (8px on each side)
                slide.style.width = `calc(${100 / slidesPerView}% - 16px)`;
            });
        ...
        function updateCarousel() {
            ...
            // Calculate the offset to move the carousel
            ...
            // Use opacity for a smoother visual transition
            prevButton.style.opacity = currentIndex === 0 ? '0' : '0.8';
            nextButton.style.opacity = currentIndex >= maxIndex ? '0' : '0.8';
        }
        ...
        // Add a "debounce" to the resize event to prevent excessive function calls
        let resizeTimeout;
