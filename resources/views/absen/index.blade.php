...
@section('content')
    <div class="flex-1 p-8">
        ...
        <div class="flex items-center gap-3 max-sm:flex-col max-sm:items-start">
            ...
            <form method="GET" action="{{ route('absen') }}" class="flex items-center border border-gray-300 rounded-lg p-2 ml-auto md:w-1/3 max-sm:w-full max-sm:items-start">
                <!-- Search Icon -->
        ...
        <div class="flex items-center gap-6 mt-8 max-sm:flex-col">
