        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name"
                    class="w-full rounded-lg px-3 py-2 border-2 k bg-input {{ $errors->has('name') ? 'border-red-500' : 'border-black' }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="description" id="description" class="w-full border-black px-3 py-2 rounded-lg bg-input border-2{{ $errors->has('description') ? 'border-red-500' : '' }}" value="{{ old('description') }}"
            ...
            <div class="flex justify-end gap-2">
                <button type="button" onclick="closeModal('createModal')" class="px-4 py-2 bg-primary text-white rounded-lg">Batal</button>
